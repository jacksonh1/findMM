...
def generate_filenames(args):
    ...
    # output alignment file (removed after alignment)
    sam_path = "{}.sam".format(k_mer_noext)
    # multi-mapping k-mers
    ...
    # MMing k_mer alignment BAM, sorted
...
def k_mer_generation(k, reference_fasta, output_k_mer_filename):
    """
    ...
    kmer_gen(k, reference_fasta, output_k_mer_filename)
